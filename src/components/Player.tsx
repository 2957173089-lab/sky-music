...
import {
  ...
  ChevronDown, Music, Heart, ListPlus, ChevronUp, AlertTriangle,
} from 'lucide-react';
...
function DesktopPlayer() {
  const { currentSong, isPlaying, togglePlay, nextSong, prevSong, currentTime, duration, loading, volume, setVolume, toggleLike, isLiked, openPlaylistModal, playError, playSource } = useStore();
    ...
    <div className="md:hidden fixed inset-0 z-[100] animate-slide-up">
      ...
      <div className="relative h-full flex flex-col"
        ...
        <div className="flex justify-center mb-2 flex-shrink-0">
          <div className="flex flex-col items-center text-slate-300 animate-swipe-hint">
            <ChevronUp size={14} />
            <span className="text-[9px]">滑动切歌</span>
          </div>
        </div>

        {/* Cover */}
        <div className="flex-1 flex items-center justify-center px-10 min-h-0" style={translateStyle}>
        ...
        {/* Play error hint */}
        {playError && (
          <div className="mx-8 mb-2 flex items-center gap-2 px-3 py-1.5 rounded-xl bg-amber-50/80 backdrop-blur">
        ...
        {/* Song Info + Like/Add */}
        <div className="px-8 mb-4 flex-shrink-0 flex items-start justify-between">
          <div className="min-w-0 flex-1">
        ...
        {/* Controls */}
        <div className="flex items-center justify-center gap-10 pb-10 pt-2 flex-shrink-0 safe-bottom">
          <button onClick={prevSong} className="text-slate-500 active:scale-90 transition">
          ...
          <button onClick={nextSong} className="text-slate-500 active:scale-90 transition">
